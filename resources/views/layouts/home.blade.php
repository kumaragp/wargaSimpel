...
<body class="bg-gray-50 font-inter">
    <header class="bg-white shadow pt-10">
        <nav
            class="w-full hover:text-green-950 flex justify-between items-center py-4 px-10 fixed top-0 left-0 right-0 bg-white shadow-md z-50">
            <a href="#home">
                <img src="images/WargaSimpel.png" class="w-32 h-auto ml-6">
            </a>
            <ul class="flex space-x-8 ml-auto">
                <li><a href="#BERANDA" class="text-green-950 hover:text-green-800">BERANDA</a></li>
                <li><a href="#tentang" class="text-green-950 hover:text-green-800">TENTANG KAMI</a></li>
                <li><a href="#kontak" class="text-green-950 hover:text-green-800">KONTAK</a></li>
                <li><a href="{{ url('pengajuan') }}"
                        class="bg-green-950 text-white py-3 px-8 rounded-lg hover:bg-green-800 transition-all duration-300">PENGAJUAN
                        SURAT</a></li>
    ...
    <section id="BERANDA" class="text-white  py-20 px-4 bg-cover bg-center"
        style="background-image: url('images/bannerfix.png');">
        ...
        <div class="container mx-auto">
            <div class="flex justify-center items-center gap-12 px-4 py-10">
                <div class="flex flex-col justify-center items-center md:items-start max-w-xl text-center md:text-left">
                    ...
                    <p class="text-8xl font-bold text-green-950 mb-6 italic">Warga<br>Simpel</p>
                </div>
                <div
    ...
    <section id="kontak" class="bg-green-950 text-black py-20 px-4">
        <div class="container mx-auto">
                    ...
                    <form action="#" method="POST">
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name"
                                class="w-full px-4 py-2 rounded-lg bg-green-950 border border-gray-600 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-green-700"
                        ...
                        <div>
                            <button type="submit"
                                class="w-full bg-white text-green-950 font-bold py-3 px-6 rounded-lg hover:bg-yellow-200">Kirim</button>
                        </div>
                    </form>
                </div>
            </div>
